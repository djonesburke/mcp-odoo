...
- [ ] `odoo-mcp --version` → **`odoo-mcp 1.3.0+burke.8`** (a bare `1.3.0` is the wrong build)
- [ ] `odoo-mcp --health` exits 0 and its JSON shows `"package_version": "1.3.0+burke.8"`
...
package_version 1.3.0+burke.8   field_acl.active true
